	...
	<body>
		...
		<!-- Footer -->
			<footer id="footer">
				...
				<!-- Icons -->
					<ul class="actions">
						<li><a href="https://twitter.com/vikmbm" class="icon fa-twitter"><span class="label">Twitter</span></a></li>
				...
				<!-- Menu -->
					<ul class="menu">
						<li>&copy; Víctor Aguilar</li><li>Design: <a href="https://www.facebook.com/avispamx/">Avispa Digital</a></li>
					</ul>
